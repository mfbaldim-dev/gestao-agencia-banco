...
st.markdown(
    "Módulo complementar focado nos rituais semanais de performance, pilares do BSC e alinhamento com a equipe.")
...
if menu_modulo == "Pilares BSC & Alinhamento":
    ...
    st.info(
        "💡 *'O nosso trabalho se sustenta nesses 5 pilares do BSC. Não buscamos apenas o resultado a qualquer custo, mas sim uma gestão comercial estruturada.'* — Gerente")
...
# 3. REGISTRO DE FEEDBACKS E ALINHAMENTOS
    ...
    st.markdown(
        "Utilize este espaço para registrar os alinhamentos rápidos feitos após o fechamento do FLOG ou durante as sessões de quarta-feira.")
    ...
    with st.form("form_feedback", clear_on_submit=True):
        ...
        with col_f2:
            tipo_sessao = st.selectbox("Tipo de Alinhamento",
                                       ["Feedback Diário (FLOG)", "Diagnóstico de Carteira (Quarta-feira)",
                                        "Revisão de Metas"])
